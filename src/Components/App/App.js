...
class App extends React.Component {
  ...
  savePlaylist() {
    alert("this method this linked correctly!")
    const trackUris = this.state.playlistTracks.map(track => track.uri);
  }

  // thisw search method allows to search for the songs via spotify api
  ...
  render(){
    return(
      ...
      onAdd={this.addTrack}/>
       <Playlist playlisyName={this.state.playlistName}
